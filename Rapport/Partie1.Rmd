...
# Calculs
null_nul     <- fig_2_opti(null_pred, 5000, 100, 1000, stockage_nul, "No stocking")
null_present <- fig_2_opti(null_pred, 5000, 100, 1000, stockage_present, "Actual stocking")
null_propose <- fig_2_opti(null_pred, 5000, 100, 1000, stockage_propose, "Theoretical stocking")

end_nul     <- fig_2_opti(endangered, 5000, 100, 1000, stockage_nul, "No stocking")
end_present <- fig_2_opti(endangered, 5000, 100, 1000, stockage_present, "Actual stocking")
end_propose <- fig_2_opti(endangered, 5000, 100, 1000, stockage_propose, "Theoretical stocking")

meas_nul     <- fig_2_opti(measured, 5000, 100, 1000, stockage_nul, "No stocking")
meas_present <- fig_2_opti(measured, 5000, 100, 1000, stockage_present, "Actual stocking")
meas_propose <- fig_2_opti(measured, 5000, 100, 1000, stockage_propose, "Theoretical stocking")
...
```{r}
#Afficher la figure 3 déja construite
print(fig3)
```
