fig_4_2 <- function(matrice_choisie, n_iterations = 100) {
  ...
  simulate_point <- function(stocking_val, stage_to_stock) {
    ...
    pop <- calculer_structure_initiale_2(matrice_choisie, 1000)
...
#Créer la figure
graphique_fig4_2 <- ggplot(df_fig4_2,
                           aes(x        = Stocking,
                               y        = Abundance_Mature,
